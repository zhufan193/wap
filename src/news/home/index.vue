<template>
  <div class="word-cup" v-title v-bind:data-title="title">
    <HeaderTop/>
    <div class="banner">
        <mt-swipe :auto="4000">
...
<script>
  import HeaderTop from '@/components/head/homeHead'
  ...
  .word-cup{
    ...
    .englishlist{
      ...
      i{
        ...
        margin-top: 0.1rem;
        height: 0.5rem;
        background: url(../../assets/bg/add.png) no-repeat center/100% 100%;
      }
      .english-list{
        width 100%;
        margin 20px 10px;
